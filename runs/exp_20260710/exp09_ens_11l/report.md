...
Moslashtirish: IoU≥0.3, conf≥0.05; mos kelgan detektsiyalar: 105 (pred=361, GT=163); vazn: `trained_8class_yolo11l.pt`

| α (YOLO ulushi) | P |
|---|---|
| 0.0 — faqat boolfs | 0.6000 |
| 0.3 | 0.8381 |
| 0.5 | 0.8476 |
| 0.7 | 0.8667 ★ |
| 1.0 — faqat YOLO | 0.8000 |

**YOLO (faqat) confusion:**

| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 0 | 0 | 0 | 0 | 0 | 5 | 1 | 0 |
| **BIRADS45** | 0 | 2 | 0 | 0 | 0 | 1 | 0 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 2 | 0 | 0 | 1 | 0 | 0 | 1 | 0 |
| **calcification** | 5 | 0 | 0 | 0 | 27 | 0 | 0 | 0 |
| **lymph_node** | 2 | 0 | 0 | 0 | 0 | 43 | 0 | 0 |
| **mass** | 2 | 0 | 0 | 0 | 0 | 2 | 11 | 0 |
...
| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 0 | 0 | 0 | 0 | 1 | 4 | 1 | 0 |
| **BIRADS45** | 0 | 2 | 0 | 0 | 0 | 1 | 0 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 3 | 0 | 0 | 1 | 0 |
| **calcification** | 0 | 0 | 0 | 0 | 32 | 0 | 0 | 0 |
| **lymph_node** | 0 | 0 | 0 | 0 | 2 | 43 | 0 | 0 |
| **mass** | 0 | 0 | 0 | 2 | 0 | 2 | 11 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## 5. Xulosa

- Umumiy P: YOLO 0.8000 → ensemble 0.8667 (+6.7 punkt).
- Yaxshilangan sinflar: **asymmetry** (recall 0.25→0.75), **calcification** (recall 0.84→1.00).
