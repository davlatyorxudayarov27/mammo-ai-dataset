...
Moslashtirish: IoU≥0.5, conf≥0.05; mos kelgan detektsiyalar: 88 (pred=329, GT=163); vazn: `yolo11s_8class.pt`

| α (YOLO ulushi) | P |
|---|---|
| 0.0 — faqat boolfs | 0.5000 |
| 0.3 | 0.7614 |
| 0.5 | 0.8182 ★ |
| 0.7 | 0.8182 |
| 1.0 — faqat YOLO | 0.7045 |
...
| **calcification** | 13 | 0 | 0 | 0 | 7 | 0 | 0 | 0 |
| **lymph_node** | 3 | 0 | 0 | 0 | 0 | 42 | 0 | 0 |
| **mass** | 0 | 0 | 0 | 0 | 0 | 2 | 12 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

**Ensemble (α=0.5) confusion:**
...
| **calcification** | 1 | 0 | 0 | 0 | 18 | 0 | 1 | 0 |
| **lymph_node** | 2 | 0 | 0 | 0 | 1 | 42 | 0 | 0 |
| **mass** | 0 | 0 | 0 | 1 | 0 | 2 | 11 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## 5. Xulosa

- Umumiy P: YOLO 0.7045 → ensemble 0.8182 (+11.4 punkt).
- Yaxshilangan sinflar: **calcification** (recall 0.35→0.90).
- Yomonlashgan sinflar: mass (0.86→0.79).
