...
## 4a. boolfs klassifikatori — val GT ROI baholash

P ((3.6.4)) = **0.6284** (148 ROI)

| Sinf | support | precision | recall |
|---|---|---|---|
| BIRADS12 | 7 | 0.136 | 0.429 |
| BIRADS45 | 4 | 0.000 | 0.000 |
| architectural_distortion | 0 | 0.000 | 0.000 |
| asymmetry | 6 | 0.500 | 0.500 |
| calcification | 61 | 0.740 | 0.934 |
| lymph_node | 51 | 0.815 | 0.431 |
| mass | 19 | 0.533 | 0.421 |
| other | 0 | 0.000 | 0.000 |
...
| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 3 | 0 | 0 | 0 | 2 | 2 | 0 | 0 |
| **BIRADS45** | 2 | 0 | 0 | 0 | 1 | 1 | 0 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 3 | 1 | 0 | 2 | 0 |
| **calcification** | 3 | 0 | 0 | 0 | 57 | 0 | 1 | 0 |
| **lymph_node** | 13 | 0 | 0 | 0 | 12 | 22 | 4 | 0 |
| **mass** | 1 | 1 | 0 | 3 | 4 | 2 | 8 | 0 |
