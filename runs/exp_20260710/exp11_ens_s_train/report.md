...
Moslashtirish: IoU≥0.3, conf≥0.05; mos kelgan detektsiyalar: 449 (pred=1244, GT=601); vazn: `yolo11s_8class.pt`

| α (YOLO ulushi) | P |
|---|---|
| 0.0 — faqat boolfs | 0.5078 |
| 0.3 | 0.7595 |
| 0.5 | 0.8174 |
| 0.7 | 0.8463 ★ |
| 1.0 — faqat YOLO | 0.8352 |

**YOLO (faqat) confusion:**

| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 2 | 1 | 0 | 0 | 0 | 6 | 1 | 0 |
| **BIRADS45** | 2 | 2 | 0 | 0 | 0 | 1 | 3 | 0 |
| **architectural_** | 0 | 0 | 2 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 3 | 0 | 0 | 4 | 0 | 0 | 3 | 0 |
| **calcification** | 21 | 0 | 0 | 0 | 70 | 0 | 0 | 0 |
| **lymph_node** | 8 | 0 | 0 | 0 | 0 | 207 | 0 | 0 |
| **mass** | 5 | 0 | 0 | 0 | 1 | 19 | 88 | 0 |
...
| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 1 | 0 | 0 | 0 | 1 | 7 | 1 | 0 |
| **BIRADS45** | 1 | 2 | 0 | 0 | 1 | 1 | 3 | 0 |
| **architectural_** | 0 | 0 | 2 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 4 | 1 | 2 | 3 | 0 |
| **calcification** | 2 | 0 | 0 | 1 | 87 | 0 | 1 | 0 |
| **lymph_node** | 5 | 0 | 0 | 0 | 13 | 197 | 0 | 0 |
| **mass** | 2 | 0 | 0 | 2 | 3 | 19 | 87 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## 5. Xulosa

- Umumiy P: YOLO 0.8352 → ensemble 0.8463 (+1.1 punkt).
- Yaxshilangan sinflar: **calcification** (recall 0.77→0.96).
- Yomonlashgan sinflar: BIRADS12 (0.20→0.10), lymph_node (0.96→0.92), mass (0.78→0.77).
