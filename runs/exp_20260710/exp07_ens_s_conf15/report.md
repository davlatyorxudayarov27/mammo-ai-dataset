...
Moslashtirish: IoU≥0.3, conf≥0.15; mos kelgan detektsiyalar: 75 (pred=142, GT=163); vazn: `yolo11s_8class.pt`

| α (YOLO ulushi) | P |
|---|---|
| 0.0 — faqat boolfs | 0.5200 |
| 0.3 | 0.8267 |
| 0.5 | 0.8800 |
| 0.7 | 0.9067 ★ |
| 1.0 — faqat YOLO | 0.9067 |

**YOLO (faqat) confusion:**

| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 0 | 0 | 0 | 0 | 0 | 2 | 0 | 0 |
| **BIRADS45** | 0 | 0 | 0 | 0 | 0 | 1 | 1 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 1 | 0 | 0 | 1 | 0 |
| **calcification** | 0 | 0 | 0 | 0 | 11 | 0 | 0 | 0 |
| **lymph_node** | 0 | 0 | 0 | 0 | 0 | 44 | 0 | 0 |
...
- Umumiy P: YOLO 0.9067 → ensemble 0.9067 (+0.0 punkt).
