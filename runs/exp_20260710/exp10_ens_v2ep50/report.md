...
Moslashtirish: IoU≥0.3, conf≥0.05; mos kelgan detektsiyalar: 103 (pred=325, GT=163); vazn: `trained_8class_ai_v2_ep50.pt`

| α (YOLO ulushi) | P |
|---|---|
| 0.0 — faqat boolfs | 0.5825 |
| 0.3 | 0.8641 ★ |
| 0.5 | 0.8641 |
| 0.7 | 0.8544 |
| 1.0 — faqat YOLO | 0.8350 |

**YOLO (faqat) confusion:**

| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 0 | 0 | 0 | 0 | 0 | 5 | 0 | 0 |
| **BIRADS45** | 0 | 2 | 0 | 0 | 0 | 2 | 0 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 1 | 0 | 0 | 1 | 0 |
| **calcification** | 3 | 0 | 0 | 0 | 28 | 0 | 0 | 0 |
| **lymph_node** | 3 | 0 | 0 | 0 | 0 | 44 | 0 | 0 |
| **mass** | 1 | 0 | 0 | 0 | 0 | 2 | 11 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

**Ensemble (α=0.3) confusion:**

| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 0 | 0 | 0 | 0 | 1 | 4 | 0 | 0 |
| **BIRADS45** | 0 | 2 | 0 | 0 | 0 | 2 | 0 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| **asymmetry** | 0 | 0 | 0 | 1 | 0 | 0 | 1 | 0 |
| **calcification** | 0 | 0 | 0 | 0 | 30 | 0 | 1 | 0 |
| **lymph_node** | 2 | 0 | 0 | 0 | 0 | 45 | 0 | 0 |
| **mass** | 0 | 0 | 0 | 1 | 0 | 2 | 11 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## 5. Xulosa

- Umumiy P: YOLO 0.8350 → ensemble 0.8641 (+2.9 punkt).
- Yaxshilangan sinflar: **calcification** (recall 0.90→0.97), **lymph_node** (recall 0.94→0.96).
