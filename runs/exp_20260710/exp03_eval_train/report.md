...
## 4a. boolfs klassifikatori — train GT ROI baholash

P ((3.6.4)) = **0.5356** (519 ROI)

| Sinf | support | precision | recall |
|---|---|---|---|
| BIRADS12 | 16 | 0.086 | 0.438 |
| BIRADS45 | 9 | 0.429 | 0.333 |
| architectural_distortion | 2 | 0.000 | 0.000 |
| asymmetry | 12 | 0.333 | 0.667 |
| calcification | 123 | 0.539 | 0.943 |
| lymph_node | 229 | 0.758 | 0.410 |
| mass | 125 | 0.750 | 0.384 |
| other | 3 | 0.500 | 0.667 |
...
| | BIRADS12 | BIRADS45 | architectural_ | asymmetry | calcification | lymph_node | mass | other |
|---|---|---|---|---|---|---|---|---|
| **BIRADS12** | 7 | 0 | 0 | 0 | 5 | 3 | 1 | 0 |
| **BIRADS45** | 2 | 3 | 0 | 0 | 1 | 1 | 2 | 0 |
| **architectural_** | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 2 |
| **asymmetry** | 0 | 0 | 0 | 8 | 1 | 1 | 2 | 0 |
| **calcification** | 4 | 0 | 0 | 2 | 116 | 0 | 1 | 0 |
| **lymph_node** | 48 | 0 | 0 | 6 | 72 | 94 | 9 | 0 |
| **mass** | 20 | 4 | 0 | 8 | 20 | 25 | 48 | 0 |
| **other** | 0 | 0 | 0 | 0 | 0 | 0 | 1 | 2 |

## 5. Xulosa (qisman)

Ensemble bosqichi hali bajarilmadi (`ensemble` buyrug'ini ishga tushiring) — YOLO bilan taqqoslash shu bosqichda to'ldiriladi.